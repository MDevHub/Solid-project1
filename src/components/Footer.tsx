...
const Footer: Component = () => {
  return (
    <footer class="mt-10 md:mt-20 border-t border-[#ffffff11] py-8 px-6">
      <div class="max-w-[1400px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-5 text-sm text-center lg:text-left">
